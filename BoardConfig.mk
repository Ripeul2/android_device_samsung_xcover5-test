...
DEVICE_PATH := device/samsung/xcover5
...
# Assert
TARGET_OTA_ASSERT_DEVICE := xcover5

# Bootloader"
TARGET_BOOTLOADER_BOARD_NAME := SRPUG21A003
...
TARGET_KERNEL_SOURCE := kernel/samsung/xcover5
TARGET_KERNEL_CONFIG := xcover5_defconfig
